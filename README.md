...
- Через REST api, токен выдаётся через админку, имеется возможность ограничить токен в правах стандартными средствами Django (через задание пользователю прав доступа в админ панеле)
